...
public class IR4 {
   ...
   //------------------------------------------------------------------------------------------------------------------
   /** Addition by Jacob
    *  Gets an Long from the keyboard. Rejects null, spaces and non-Longs.
     * @param msg is the text that will be displayed the user to ask them to enter a number.
     * @return Returns a long from the keyboard. 
     */  
   public static long getLong(String msg){
      System.out.println(msg);
      while (!keyboard.hasNextLong()){
         keyboard.nextLine();
         System.err.println("Invalid Long input. Try again.");
      }
